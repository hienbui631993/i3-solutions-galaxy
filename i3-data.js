...
export const SOLUTIONS = [
  ...
  { id: "chat", label: "i3 Chat / Ask i3", short: "Ask i3", pillar: "P2" },
  { id: "host", label: "i3Host Management Platform", short: "i3Host", pillar: "P2" },
  ...
  { id: "pos", label: "POS Integration", short: "POS Integration", pillar: "P3" },
...
export const PAINS = [
  { id: "pp_age_id_verification_compliance", label: "Age (ID) verification / compliance", short: "Age (ID) verification / compliance", kw: ["age", "verification", "compliance", "id"], sols: ["stream", "incident", "smarter", "pos"], verts: ["v_cstore", "v_grocery"] , desc: "Failure to check ID for age-restricted products (alcohol, tobacco, cannabis) exposes the store to fines, licence suspension, and regulatory action." },
  ...
  { id: "pp_cannabis_tobacco_compliance", label: "Cannabis/Tobacco compliance", short: "Cannabis/Tobacco compliance", kw: ["cannabis", "tobacco", "compliance", "age"], sols: ["stream", "incident", "smarter", "pos"], verts: ["v_cstore"] , desc: "Selling age-restricted products without verified compliance creates licence risk; dispensary-adjacent stores face heightened scrutiny from regulators." },
  { id: "pp_cash_handling_risk", label: "Cash handling risk", short: "Cash handling risk", kw: ["cash", "handling", "risk", "drawer", "till"], sols: ["stream", "incident", "svc_anom", "smarter", "drawer", "pos", "apanalyst"], verts: ["v_qsr", "v_cstore", "v_grocery", "v_retail", "v_thrift"] , desc: "Unmonitored till counts, shift changes, and drops create exposure to internal theft and discrepancy disputes that are hard to resolve without video-linked POS data." },
  { id: "pp_centralized_investigations", label: "Centralized investigations", short: "Centralized investigations", kw: ["centralized", "investigations", "central", "investigation"], sols: ["stream", "incident", "alert", "host", "smarter", "pos", "apanalyst"], verts: ["v_qsr", "v_cstore", "v_grocery", "v_commercial", "v_education", "v_retail", "v_thrift"] , desc: "LP teams managing multiple sites struggle to pull and review footage across locations quickly, slowing case build times and increasing investigation cost." },
  ...
  { id: "pp_food_waste", label: "Food Waste %", short: "Food Waste %", kw: ["food", "waste"], sols: ["shelf", "smarter", "pos"], verts: ["v_qsr", "v_cstore", "v_grocery", "v_retail", "v_thrift"] , desc: "Expired, spoiled, or over-ordered perishables represent direct margin loss and a growing compliance concern where food waste reporting is mandated." },
  { id: "pp_franchise_consistency", label: "Franchise consistency", short: "Franchise consistency", kw: ["franchise", "consistency"], sols: ["svc_anom", "engage", "overflow", "loyalty", "qalert", "people", "velocity", "donation", "region", "shelf", "table", "smarter", "pos"], verts: ["v_qsr", "v_cstore", "v_grocery", "v_retail", "v_thrift"], desc: "Individual franchise operators may not follow brand SOPs consistently, creating a gap between brand promise and customer experience across locations." },
  ...
  { id: "pp_investigation_time", label: "Investigation Time", short: "Investigation Time", kw: ["investigation", "time", "footage", "search"], sols: ["sentry", "lpr", "csm", "evt", "slip", "door", "thermal", "talkdown", "stream", "incident", "alert", "trueview", "alarms", "loitering", "svc_anom", "traj_analysis", "chat", "btb", "walkout", "traj_anom", "smarter", "drawer"], verts: ["v_cstore", "v_grocery", "v_commercial", "v_retail"], desc: "Reviewing hours of footage manually to build a case is expensive and slow; delays reduce recovery rates and increase LP team burnout." },
  { id: "pp_labor_of_sales", label: "Labor % of Sales", short: "Labor % of Sales", kw: ["labor", "sales", "labour"], sols: ["engage", "overflow", "qalert", "people", "velocity", "donation", "region", "table", "heatmap", "pos"], verts: ["v_qsr", "v_cstore", "v_grocery", "v_retail", "v_thrift"], desc: "Labour cost as a share of revenue is a key profitability metric; without traffic and transaction data it is impossible to right-size staffing to demand." },
  { id: "pp_labor_shortages", label: "Labor shortages", short: "Labor shortages", kw: ["labor", "shortages", "labour", "shortage"], sols: ["engage", "overflow", "qalert", "people", "velocity", "donation", "region", "table", "heatmap", "pos"], verts: ["v_qsr", "v_cstore", "v_grocery", "v_retail", "v_thrift"], desc: "Difficulty hiring and retaining frontline staff leaves stores understaffed, degrading service levels and increasing the burden on existing team members." },
  { id: "pp_limited_lp_ap_resources", label: "Limited LP/AP resources", short: "Limited LP/AP resources", kw: ["limited", "resources", "lp", "ap", "resource", "analyst"], sols: ["sentry", "lpr", "csm", "evt", "slip", "door", "thermal", "talkdown", "incident", "alert", "trueview", "alarms", "loitering", "svc_anom", "traj_analysis", "chat", "btb", "walkout", "traj_anom", "smarter", "drawer", "apanalyst"], verts: ["v_qsr", "v_cstore", "v_grocery", "v_retail", "v_thrift"], desc: "Small LP teams cannot cover all locations and all shifts; they need smart tools to prioritise where to focus rather than reviewing footage reactively." },
  ...
  { id: "pp_multi_location_consistency", label: "Multi-location consistency", short: "Multi-location consistency", kw: ["multi", "location", "consistency"], sols: ["host", "svc_anom"], verts: ["v_retail", "v_qsr", "v_grocery"] , desc: "Operating standards, service times, and compliance levels vary across sites; without a unified view, underperforming locations are hard to identify and correct." },
  { id: "pp_multi_site_management_complexity", label: "Multi-site management complexity", short: "Multi-site management complexity", kw: ["multi", "site", "management", "complexity"], sols: ["sentry", "lpr", "csm", "stream", "alert", "trueview", "host"], verts: ["v_qsr", "v_cstore", "v_grocery", "v_commercial", "v_education", "v_retail", "v_thrift"], desc: "Managing security, operations, and compliance across dozens or hundreds of sites from disparate systems creates gaps and inefficiencies." },
  ...
  { id: "pp_site_uptime_monitoring", label: "Site uptime monitoring", short: "Site uptime monitoring", kw: ["site", "uptime", "monitoring", "monitor", "health"], sols: ["host"], verts: ["v_commercial", "v_retail", "v_grocery", "v_cstore"] , desc: "Camera or system outages create unmonitored gaps that are exploited by offenders; downtime also delays incident response and breaks the evidence chain." },
  ...
  { id: "pp_video_access_governance", label: "Video access governance", short: "Video access governance", kw: ["video", "access", "governance", "permission", "audit"], sols: ["pos", "host", "evt"], verts: ["v_commercial", "v_retail", "v_grocery"] , desc: "Unrestricted access to live and recorded video creates data breach risk and privacy liability; role-based access and audit logs are a regulatory expectation." },
  ...
  { id: "pp_kitchen_equipment_downtime", label: "Kitchen equipment downtime", short: "Kitchen equipment downtime", kw: ["kitchen", "equipment", "downtime", "breakdown", "fryer", "grill"], sols: ["svc_anom", "host", "alert", "incident"], verts: ["v_qsr"] , desc: "Equipment breakdowns in a QSR kitchen force menu items off sale, create safety risks, and erode customer satisfaction; detection time is a key cost driver." },
